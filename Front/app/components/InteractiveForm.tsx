...
export default function InteractiveForm() {
  ...
  return (
    <div id="chat-content" className="flex flex-col space-y-4">
      {messages.map((msg, index) => (
        <div
          ...
          className={`
            ...
            mb-4
            relative  /* Asegura que el botón de copiar se posicione dentro del contenedor */
          `}
        >
      ...
      {/* Botón para bajar al final, visible solo cuando el bot haya respondido */}
...
//         <div
//           key={index}
//           className={`flex flex-col p-4 rounded-lg relative ${
//             msg.sender === 'Bot'
...
// //       {messages.some((msg) => msg.sender === 'Bot') && (
// //         <div className="mt-6 text-white p-2">
